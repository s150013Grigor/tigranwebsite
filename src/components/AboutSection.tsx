...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 md:py-32 3xl:py-28 4xl:py-36 bg-primary">
      <div className="max-w-7xl xl:max-w-[1400px] 2xl:max-w-[1600px] 3xl:max-w-[1800px] 4xl:max-w-[85%] 5xl:max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 4xl:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 4xl:gap-24 items-center">
          ...
          {/* Content — POV copy */}
          <div>
            <p className="text-white/50 text-sm 3xl:text-base 4xl:text-lg tracking-[0.3em] uppercase mb-4 font-body">
              Wie ik ben
            </p>
            <h2 className="text-3xl md:text-4xl 2xl:text-5xl 4xl:text-6xl 5xl:text-7xl font-heading font-bold text-white mb-6">
              Over Tigran
            </h2>

            <p className="text-white font-heading text-xl md:text-2xl 2xl:text-3xl 4xl:text-4xl italic leading-snug mb-6">
            ...
            {/* Approach highlights */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 4xl:gap-6 mt-8">
              {[
